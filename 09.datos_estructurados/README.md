...
# BUSCAR
## este metodo permite ubicar a traves del valor el primer (la primera coincidencia) elemento dentro de una lista, y devolvera el indice de ese valor, este metodo es index
amantes:list[str]=['chapo','cristian','emerson','victor']
# quiero ubicar si en mi lista de infieles existe victor
buacar:int=index("victor")#retorna un indice si existe 3
