...
### METODOS PARA STRING
## permiten manipular, buscar, transformar y extraer información de texto en programación
##length() (longitud), charAt() (carácter en posición), substring() (fragmento), toUpperCase()/toLowerCase() (mayúsculas/minúsculas), trim() (quitar espacios), y replace() (reemplazar texto)
### Métodos Esenciales de String (General/Java/JS)

## charAt(index): Devuelve el carácter en la posición especificada 
## substring(inicio, fin): Extrae una parte de la cadena 
## concat(otraCadena): Une dos o más cadenas 
